...
import telegram
from Ai_Ohto import TIGERS, WOLVES, dispatcher
from Ai_Ohto.modules.disable import DisableAbleCommandHandler
from Ai_Ohto.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
    user_admin_no_reply)
from Ai_Ohto.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from Ai_Ohto.modules.helper_funcs.string_handling import split_quotes
from Ai_Ohto.modules.log_channel import loggable
from Ai_Ohto.modules.sql import warns_sql as sql
