...
import Ai_Ohto.modules.sql.notes_sql as sql
from Ai_Ohto import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from Ai_Ohto.__main__ import DATA_IMPORT
from Ai_Ohto.modules.helper_funcs.chat_status import user_admin
from Ai_Ohto.modules.helper_funcs.alternate import typing_action

# from Ai_Ohto.modules.rules import get_rules
import Ai_Ohto.modules.sql.rules_sql as rulessql

# from Ai_Ohto.modules.sql import warns_sql as warnssql
import Ai_Ohto.modules.sql.blacklist_sql as blacklistsql
from Ai_Ohto.modules.sql import disable_sql as disabledsql

# from Ai_Ohto.modules.sql import cust_filters_sql as filtersql
# import Ai_Ohto.modules.sql.welcome_sql as welcsql
import Ai_Ohto.modules.sql.locks_sql as locksql
from Ai_Ohto.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("Ai_Ohto{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Ai_Ohto{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Ai_Ohto-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl,
        ),
        timeout=360,
    ...
    os.remove("Ai_Ohto{}.backup".format(chat_id))  # Cleaning file
